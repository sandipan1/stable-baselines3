...
from stable_baselines3.custom_her.goal_selection_strategy import KEY_TO_GOAL_STRATEGY, GoalSelectionStrategy
...
class HerReplayBuffer(DictReplayBuffer):
    ...
    def __init__(
        ...
        self.goal_image_shape = get_obs_shape(self.env.observation_space.spaces["desired_goal_image"])
        ...
        input_shape = {
            ...
            "achieved_goal_image": (1,) + self.goal_image_shape,
            "desired_goal": (1,) + self.goal_shape,
            "desired_goal_image" :  (1,) + self.goal_image_shape,
        ...
        self._observation_keys = ["observation", "achieved_goal", "desired_goal" , "achieved_goal_image","desired_goal_image"]
        self._buffer = {
    ...
    def sample(
        ...
        ## TODO dont used maybe_vec_env and see what happens 
        return self._sample_transitions(batch_size, maybe_vec_env=None, online_sampling=True)  # pytype: disable=bad-return-type 
    ...
    def sample_goals(
        ...
        return self._buffer["achieved_goal"][her_episode_indices, transitions_indices] , self._buffer["achieved_goal_image"][her_episode_indices,transitions_indices]
    ...
    def _sample_transitions(
        ...
        new_goals, new_goal_images = self.sample_goals(episode_indices, her_indices, transitions_indices)
        transitions["desired_goal"][her_indices] = new_goals
        transitions["desired_goal_image"][her_indices] = new_goal_images
        ...
        next_observations = {
            ...
            "achieved_goal_image": transitions["next_achieved_goal_image"],
